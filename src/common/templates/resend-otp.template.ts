// email-templates/buildResendOtpEmail.ts
export function buildResendOtpEmail(opts: {
  otpCode: string;
  appName?: string;
  supportEmail?: string;
  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>${appName} — Resend OTP</title>
        <style>
      ...
      <body style="margin:0; padding:0;" class="bg">
        <div class="preheader">
          Your ${appName} OTP code is ${otpCode}. It expires in ${expiresInMinutes} minutes.
        </div>
                      ...
                      <tr>
                        <td style="padding: 32px;">
                          ...
                          <p class="text" style="margin:0 0 16px 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial; font-size:14px; line-height:1.6; color:#374151;">
                            As requested, we’ve sent you a new OTP code. Please use the following code to complete your verification process.
                          </p>
