// email-templates/buildVerificationEmail.ts
export function buildVerificationEmail(opts: {
  ...
  // Tip: keep this under ~100KB total to avoid Gmail clipping
  return `
  <!doctype html>
  <html lang="en">
    <head>
      ...
      <!-- Preheader text: shows as preview in inbox -->
      <style>
    ...
    <body style="margin:0; padding:0;" class="bg">
      <div class="preheader">
        Your ${appName} verification code is ${otpCode}. It expires in ${expiresInMinutes} minutes.
      </div>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td align="left" style="font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,'Apple Color Emoji','Segoe UI Emoji'; font-size:14px; color:#94a3b8; padding:8px 0;">
                        <!-- Optional logo: you can replace with an <img> tag -->
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" class="card" style="background:#ffffff; border:1px solid #e5e7eb; border-radius:12px;">
                    <tr>
                      <td style="padding: 32px;">
                        <h1 class="text" style="margin:0 0 8px 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,'Apple Color Emoji','Segoe UI Emoji'; font-weight:700; font-size:20px; color:#111827;">
                          Verify your email
                        </h1>
                        <p class="text" style="margin:0 0 16px 0; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial; font-size:14px; line-height:1.6; color:#374151;">
                          Dear User,
                          <br/>Thank you for registering with us. Please use the following OTP code to verify your email address.
                        </p>
                        ...
                        <!-- Button (optional, some apps verify by link as well) -->
                        <!--
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin: 8px 0 20px 0;">
                          <tr>
                            <td class="btn" style="border-radius:8px; background:#2563eb;">
                              <a href="https://app.rabbithole.example/verify?code=${encodeURIComponent(
                                otpCode,
                              )}" target="_blank" rel="noopener" style="display:inline-block; padding:12px 20px; text-decoration:none; font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial; font-size:14px; font-weight:600; color:#ffffff;">
                                Verify Email
                              </a>
                            </td>
                          </tr>
